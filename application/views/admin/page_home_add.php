...
<script>
	const STORAGE_KEY = "currentHomeStepTab";
		...
		<div class="row">
			<div class="page-heading">
				<div class="row align-items-center">
					<div class="col-6">
						<h3>ตั้งค่าหน้าหลัก — <?= htmlspecialchars($hotelData['title_th'] ?? ''); ?></h3>
					</div>
			...
			<div class="page-content">
				<div class="card shadow-sm mb-3">
					<div class="card-body px-4">
						...
						<form action="<?= admin_url('hotel_home/save/' . ($hotelData['hotel_id'] ?? '')); ?>" method="post" enctype="multipart/form-data" autocomplete="off" novalidate>
								...
								<div class="tab-pane fade show active" id="step1">
									...
									<div class="section-box">
										...
										<div class="row">
											...
											<div class="form-group col-lg-12 mb-3">
												...
												<input type="text" name="banner_title_th" class="form-control" placeholder="เช่น ยินดีต้อนรับสู่โรงแรม">
											</div>
									...
									<div class="section-box">
										...
										<div class="row">
											<div class="form-group col-lg-6 mb-3">
												...
												<input type="text" name="about_title_th" class="form-control" placeholder="เช่น เกี่ยวกับเรา">
											</div>
											<div class="form-group col-lg-6 mb-3">
												<label>Subtitle (ภาษาไทย)</label>
												<input type="text" name="about_subtitle_th" class="form-control" placeholder="เช่น ประสบการณ์การพักผ่อนที่ไม่เหมือนใคร">
											</div>
											<div class="form-group col-lg-12 mb-0">
												<label>คำอธิบาย / Description (ภาษาไทย)</label>
												<textarea name="about_desc_th" class="form-control" rows="5" placeholder="รายละเอียดเกี่ยวกับโรงแรม ที่ตั้ง ความโดดเด่น ฯลฯ"></textarea>
											</div>
										</div>
									</div>
									...
									<div class="section-box">
										...
										<div class="row">
											<div class="form-group col-lg-12 mb-3">
												...
												<textarea name="rooms_desc_th" class="form-control" rows="4" placeholder="คำอธิบายภาพรวมของห้องพักที่นำเสนอในหน้าหลัก"></textarea>
											</div>
									...
									<div class="section-box mb-0">
										...
										<div class="row">
											<div class="form-group col-lg-6 mb-3">
												<label>Title (ภาษาไทย)<sup class="text-danger">*</sup></label>
												<input type="text" name="facilities_title_th" class="form-control" placeholder="เช่น สิ่งอำนวยความสะดวก">
											</div>
											<div class="form-group col-lg-6 mb-3">
												<label>Subtitle (ภาษาไทย)</label>
												<input type="text" name="facilities_subtitle_th" class="form-control" placeholder="เช่น ทำไมต้องเลือกเรา">
											</div>
											<div class="form-group col-lg-12 mb-0">
												<label>คำอธิบาย / Description (ภาษาไทย)</label>
												<textarea name="facilities_desc_th" class="form-control" rows="4" placeholder="รายละเอียดสิ่งอำนวยความสะดวกที่โรงแรมมีให้"></textarea>
											</div>
										</div>
									</div>
								...
								<div class="tab-pane fade" id="step2">
									...
									<div class="section-box">
										...
										<div class="row">
											<div class="form-group col-lg-12 mb-3">
												...
												<input type="text" name="banner_title_en" class="form-control" placeholder="e.g. Welcome to our Hotel">
											</div>
											<div class="form-group col-lg-12 mb-0">
												<label>Description (English)</label>
												<textarea name="banner_desc_en" class="form-control" rows="3" placeholder="Short description for the main banner"></textarea>
											</div>
										</div>
									</div>
									...
									<div class="section-box">
										...
										<div class="row">
											<div class="form-group col-lg-6 mb-3">
												<label>Title (English)<sup class="text-danger">*</sup></label>
												<input type="text" name="about_title_en" class="form-control" placeholder="e.g. About Us">
											</div>
											<div class="form-group col-lg-6 mb-3">
												<label>Subtitle (English)</label>
												<input type="text" name="about_subtitle_en" class="form-control" placeholder="e.g. A Unique Stay Experience">
											</div>
											<div class="form-group col-lg-12 mb-0">
												<label>Description (English)</label>
												<textarea name="about_desc_en" class="form-control" rows="5" placeholder="Hotel description, location highlights, etc."></textarea>
											</div>
										</div>
									</div>
									...
									<div class="section-box">
										...
										<div class="row">
											<div class="form-group col-lg-12 mb-0">
												<label>Description (English)</label>
												<textarea name="rooms_desc_en" class="form-control" rows="4" placeholder="Overview description of the rooms shown on the home page"></textarea>
											</div>
										</div>
									...
									<div class="section-box mb-0">
										...
										<div class="row">
											<div class="form-group col-lg-6 mb-3">
												<label>Title (English)<sup class="text-danger">*</sup></label>
												<input type="text" name="facilities_title_en" class="form-control" placeholder="e.g. Our Facilities">
											</div>
											<div class="form-group col-lg-6 mb-3">
												<label>Subtitle (English)</label>
												<input type="text" name="facilities_subtitle_en" class="form-control" placeholder="e.g. Why Choose Us">
											</div>
											<div class="form-group col-lg-12 mb-0">
												<label>Description (English)</label>
												<textarea name="facilities_desc_en" class="form-control" rows="4" placeholder="Describe the facilities available at the hotel"></textarea>
											</div>
										</div>
									</div>
